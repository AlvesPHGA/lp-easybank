...
const Subheader = () => {
   return (
      <section className="relative h-fit pt-[7rem] pb-[7.7rem] flex bg-veryLightGray z-0  ">
         <div className="absolute bg-backDesktop right-0 z-[-1] w-[57vw] h-[100vh] top-[-215px] bg-cover bg-no-repeat bg-customPosition01 bg-custom02 smallDevice:block smallDevice:bg-backDevice smallDevice:h-[47vh] smallDevice:w-full smallDevice:relative smallDevice:top-0 smallDevice:bg-cBS_mbl01 smallDevice:bg-subHomeMobile mediumDevice:block mediumDevice:bg-backDevice mediumDevice:h-[47vh] mediumDevice:w-full mediumDevice:relative mediumDevice:top-0 mediumDevice:bg-cBS_mbl01 mediumDevice:bg-subHomeMobile"></div>
         ...
         <div className="absolute bg-mockup bg-ba w-[50vw] h-[840px] z-[-1] bg-no-repeat bg-custom bg-[152px] top-[-115px] posi right-0 smallDevice:h-[70vh] smallDevice:left-0 smallDevice:w-full smallDevice:bg-contain smallDevice:bg-[center] smallDevice:top-[-115px]  mediumDevice:h-[70vh] mediumDevice:left-0 mediumDevice:w-full mediumDevice:bg-contain mediumDevice:bg-[center] mediumDevice:top-[-115px]"></div>
      </section>
   );
};
