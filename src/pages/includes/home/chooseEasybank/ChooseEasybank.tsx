   ...
   return (
      <section className="py-28 bg-lightGrayishBlue smallDevice:py-10">
         <div className="w-1200 m-auto smallDevice:w-full smallDevice:px-4">
            ...
            <p className="text-grayishBlue w-[690px] mt-6 mb-16 smallDevice:w-full smallDevice:text-base smallDevice:text-center">
               We leverage Open Banking to turn your bank account into your
               financial hub. Control your finances like never before.
            </p>

            <div className="flex gap-4 justify-between smallDevice:flex-col smallDevice:gap-6 smallDevice:items-center">
