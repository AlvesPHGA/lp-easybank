...
const Header = () => {
   ...
   return (
      <header className="h-24 flex bg-white relative z-[100] smallDevice:fixed smallDevice:w-[100vw] smallDevice:top-0 smallDevice:h-[100px] mediumDevice:fixed mediumDevice:w-[100vw] mediumDevice:top-0 mediumDevice:h-[100px] largerDevice:w-[100vw] largerDevice:fixed largerDevice:top-0 largerDevice:h-[100px] largerDevice:px-6">
